...
class Lenox:
    ...
    def convchain(self, query: str, session_id: str = "my_session") -> dict:
        ...
        if "search" in query.lower():  # Detect search query
            search_query = query.lower().replace("search", "").strip()
            search_result = self.web_search_manager.run_search(search_query)
            return {"type": "text", "content": search_result['content']}
    ...
    def handle_gpt_research_query(self, query: str, report_type: str = "research_report", report_source: str = "web") -> dict:
        """
        Handle GPT Researcher queries.
        
        Args:
            query (str): The research query.
            report_type (str): The type of report to generate.
            report_source (str): The source of the report (e.g., "web", "local").
        
        Returns:
            dict: The research report generated by GPT Researcher.
        """
        return self.web_search_manager.run_gpt_research(query=query, report_type=report_type, report_source=report_source)
